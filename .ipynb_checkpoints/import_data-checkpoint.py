...
nasdaq = pd.read_excel("/Users/admin/Documents/IP/data/Input/ISIN_merge.xlsx") 
...
def process_content(content: bytes) -> pd.DataFrame:
    """Processes the extracted content and returns dataframe that holds the required info or no info at all"""
...
if __name__ == "__main__":       
    ...
    for count in range(count,downloads_count):
        data = main(count)
        name=str(count)
        file = open("/Users/admin/Documents/IP/data/DD_download/results_" + name + ".pkl", 'wb')
